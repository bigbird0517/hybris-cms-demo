 ...
 *  
 */
package com.crownpartners.cmsdemo.cockpits.productcockpit.editor;
			...
			if (section instanceof CustomEditorSection)
			{
				...
				if (customSection.getSectionConfiguration() instanceof ExternalTaxesSectionConfiguration)
				{
					...
					if (secConfig != null)
					{
						...
						final Label rowLabel = new Label(Labels.getLabel("cmsdemocockpits.product.externalTaxes"));
						rowLabel.setTooltiptext(Labels.getLabel("cmsdemocockpits.product.externalTaxes"));
