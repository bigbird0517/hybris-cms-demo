 ...
 *  
 */
package com.crownpartners.cmsdemo.cockpits.setup;
...
import com.crownpartners.cmsdemo.cockpits.constants.CmsdemoCockpitsConstants;
 ...
 */
@SystemSetup(extension = CmsdemoCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(CmsdemoCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(CmsdemoCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						CmsdemoCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				importImpexFile(context, "/cmsdemocockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
			}
