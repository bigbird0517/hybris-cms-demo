 ...
 *  
 */
package com.crownpartners.cmsdemo.core.hmc;
...
/**
 * Provides necessary meta information about the cmsdemocore hmc extension.
 * 
 * 
 * @version ExtGen v4.1
 */
public class CmsdemoCoreHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(CmsdemoCoreHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public static final String RESOURCE_PATH = "com.crownpartners.cmsdemo.core.hmc.locales";
