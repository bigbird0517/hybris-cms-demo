 ...
 *  
 */
package com.crownpartners.cmsdemo.core.setup;
...
import com.crownpartners.cmsdemo.core.constants.CmsdemoCoreConstants;
 ...
 */
@SystemSetup(extension = CmsdemoCoreConstants.EXTENSIONNAME)
public class CoreSystemSetup extends AbstractSystemSetup
{
	...
	{
		importImpexFile(context, "/cmsdemocore/import/common/essential-data.impex");
		importImpexFile(context, "/cmsdemocore/import/common/countries.impex");
		importImpexFile(context, "/cmsdemocore/import/common/delivery-modes.impex");

		importImpexFile(context, "/cmsdemocore/import/common/themes.impex");
		importImpexFile(context, "/cmsdemocore/import/common/user-groups.impex");
	}
	...
	public void createProjectData(final SystemSetupContext context)
	{
		...
		{
			importImpexFile(context, "/cmsdemocore/import/cockpits/cmscockpit/cmscockpit-users.impex");
			importImpexFile(context, "/cmsdemocore/import/cockpits/cmscockpit/cmscockpit-access-rights.impex");
		}

		if (importAccessRights && extensionNames.contains("btgcockpit"))
		{
			importImpexFile(context, "/cmsdemocore/import/cockpits/cmscockpit/btgcockpit-users.impex");
			importImpexFile(context, "/cmsdemocore/import/cockpits/cmscockpit/btgcockpit-access-rights.impex");
		}

		if (importAccessRights && extensionNames.contains("productcockpit"))
		{
			importImpexFile(context, "/cmsdemocore/import/cockpits/productcockpit/productcockpit-users.impex");
			importImpexFile(context, "/cmsdemocore/import/cockpits/productcockpit/productcockpit-access-rights.impex");
			importImpexFile(context, "/cmsdemocore/import/cockpits/productcockpit/productcockpit-constraints.impex");
		}

		if (importAccessRights && extensionNames.contains("cscockpit"))
		{
			importImpexFile(context, "/cmsdemocore/import/cockpits/cscockpit/cscockpit-users.impex");
			importImpexFile(context, "/cmsdemocore/import/cockpits/cscockpit/cscockpit-access-rights.impex");
		}

		if (importAccessRights && extensionNames.contains("reportcockpit"))
		{
			importImpexFile(context, "/cmsdemocore/import/cockpits/reportcockpit/reportcockpit-users.impex");
			importImpexFile(context, "/cmsdemocore/import/cockpits/reportcockpit/reportcockpit-access-rights.impex");
		}

		if (extensionNames.contains("mcc"))
		{
			importImpexFile(context, "/cmsdemocore/import/common/mcc-sites-links.impex");
		}
	...
	private class ImportCatalogAwareDataStrategy
	{
		...
		private void createAndActivateSolrIndex(final String storeName)
		{
			...
			importImpexFile(context, "/cmsdemocore/import/stores/" + storeName + "/solr.impex");

			createSolrIndexerCronJobs(storeName + "Index");

			importImpexFile(context, "/cmsdemocore/import/stores/" + storeName + "/solrtrigger.impex");
		...
		private void createStore(final String storeName)
		{
			...
			importImpexFile(context, "/cmsdemocore/import/stores/" + storeName + "/store.impex");
			importImpexFile(context, "/cmsdemocore/import/stores/" + storeName + "/site.impex");
		...
		private void createContentCatalog(final String contentCatalogName)
		{
			...
			importImpexFile(context, "/cmsdemocore/import/contentCatalogs/" + contentCatalogName
		...
		private void createProductCatalog(final String productCatalogName)
		{
			...
			importImpexFile(context, "/cmsdemocore/import/productCatalogs/" + productCatalogName
