 ...
 *  
 */
package com.crownpartners.cmsdemo.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(CmsdemoFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(CmsdemoFulfilmentProcessConstants.PARENT_PROCESS);
