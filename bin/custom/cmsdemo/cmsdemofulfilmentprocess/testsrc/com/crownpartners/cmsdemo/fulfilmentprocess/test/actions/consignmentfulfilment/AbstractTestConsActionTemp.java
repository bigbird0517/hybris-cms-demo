 ...
 *  
 */
package com.crownpartners.cmsdemo.fulfilmentprocess.test.actions.consignmentfulfilment;
...
public abstract class AbstractTestConsActionTemp extends TestActionTemp
{
	...
	{
		final String parentCode = (String) getProcessParameterValue(process, CmsdemoFulfilmentProcessConstants.PARENT_PROCESS);
