 ...
 *  
 */
package com.crownpartners.cmsdemo.fulfilmentprocess.test.jobs;
...
import com.crownpartners.cmsdemo.fulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = CmsdemoFulfilmentProcessConstants.ORDER_PROCESS_NAME;
