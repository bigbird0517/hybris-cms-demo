 ...
 *  
 */
package com.crownpartners.cmsdemo.initialdata.setup;
...
import com.crownpartners.cmsdemo.core.setup.CoreSystemSetup;
import com.crownpartners.cmsdemo.initialdata.constants.CmsdemoInitialDataConstants;
 ...
 */
@SystemSetup(extension = CmsdemoInitialDataConstants.EXTENSIONNAME)
public class InitialDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		...
		// importCommonData(context, "cmsdemoinitialdata");
		// This would import a standard store: (one basestore, one cmssite, one product catalog, one content catalog)
		// importStoreInitialData(context, "cmsdemoinitialdata", "yaccelerator", "yaccelerator", Collections.singletonList("yaccelerator"));
		...
		if (getBooleanSystemSetupParameter(context, IMPORT_SAMPLE_DATA))
		{
			...
			getEventService().publishEvent(
					new SampleDataImportedEvent(context, Arrays.asList(electronicsImportData)));
		}
	}
