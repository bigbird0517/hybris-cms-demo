 ...
 *  
 */
package com.crownpartners.cmsdemo.test.setup;
...
import com.crownpartners.cmsdemo.test.constants.CmsdemoTestConstants;
import com.crownpartners.cmsdemo.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = CmsdemoTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/cmsdemotest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/cmsdemotest/import/reviews.impex");
			...
			importImpexFile(context, "/cmsdemotest/import/cstickets.impex");
		}
	}
}
