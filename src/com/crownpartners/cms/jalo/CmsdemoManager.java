 ...
 *  
 */
package com.crownpartners.cms.jalo;
...
import com.crownpartners.cms.constants.CmsdemoConstants;



/**
 * This is the extension manager of the Cmsdemo extension.
 */
public class CmsdemoManager extends GeneratedCmsdemoManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(CmsdemoManager.class.getName());
	 ...
	 */
	public static CmsdemoManager getInstance()
	{
		return (CmsdemoManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				CmsdemoConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public CmsdemoManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of CmsdemoManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of CmsdemoManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of CmsdemoManager called, current tenant: " + getTenant().getTenantID());
		}
	}
